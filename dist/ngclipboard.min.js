...
!function(){"use strict";var a,b="ngclipboard";"undefined"!=typeof module&&"object"==typeof module.exports?(a=require("angular"),module.exports=b):a=window.angular,a.module(b,[]).directive("ngclipboard",function(){return{restrict:"A",scope:{ngclipboardSuccess:"&",ngclipboardError:"&"},link:function(a,b){var c=b.attr("id");c||(b.attr("id","ngclipboard"+Date.now()),c=b.attr("id"));var d=new Clipboard("#"+c);d.on("success",function(b){a.ngclipboardSuccess({e:b})}),d.on("error",function(b){a.ngclipboardError({e:b})})}}})}();